    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 pt-16 pb-8 text-center">
        ...
        <p className="text-[#64748B] text-base leading-relaxed max-w-sm">
          Accept payments, manage bookings, track expenses, and grow your business, all in one place.
        </p>
        {/* Feature pills */}
        <div className="flex flex-wrap justify-center gap-2 mt-8">
          {['Online bookings', 'Paystack payments', 'Expense tracking', 'Business reports'].map((f) => (
